import { At as runWithAdapter, C as serializeSignedCookie, Ct as ATTR_HOOK_TYPE, D as importJWK, Dt as getAuthTables, E as decodeProtectedHeader, Et as safeJSONParse, Ft as generateId, Gt as email, Ht as any, It as createRandomStringGenerator, Jt as number, Mt as getBetterAuthVersion, Nt as initGetModelName, O as jwtVerify, Ot as getCurrentAdapter, Pt as initGetFieldName, Qt as string, Rt as base64Url, S as serializeCookie, Sn as BASE_ERROR_CODES, St as ATTR_CONTEXT, T as decodeJwt, Tt as import_src, Ut as array, Wt as boolean, Xt as optional, Yt as object, Z as encode, Zt as record, _ as runWithRequestState, _n as isProduction, a as createAuthorizationURL, an as betterFetch, b as createRouter$1, bn as BetterAuthError, c as createRateLimitKey, cn as normalizePathname, d as deprecate, dn as shouldPublishLog, f as createAuthEndpoint, g as hasRequestState, gn as isDevelopment, h as defineRequestState, i as refreshAccessToken, jt as runWithTransaction, kt as queueAfterTransactionHook, l as findInvalidTrustedProxies, ln as createLogger, lt as JWTExpired, m as isAPIError, n as socialProviders, o as applyDefaultAccessTokenExpiry, p as createAuthMiddleware, pn as env, qt as looseObject, r as validateAuthorizationCode, s as isLoopbackHost, t as SocialProviderListEnum, u as getIp, un as logger, v as getCurrentAuthContext, vn as isTest, w as filterOutputFields, wt as ATTR_OPERATION_ID, x as toResponse, xn as kAPIErrorHeaderSymbol, xt as withSpan, y as runWithEndpointContext, yn as APIError } from "../_libs/@better-auth/core+[...].mjs";
...
import { a as verifyPassword$1, i as symmetricEncrypt, n as hashPassword$1, r as symmetricDecrypt } from "./crypto-COYSB0ju.mjs";
...
import { n as getPglite, t as ensureDbReady } from "./db-CDr21QXK.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-BlGeXjxy.js
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-DiJNCklL.mjs").then((n) => n.a).then((n) => n.t);
